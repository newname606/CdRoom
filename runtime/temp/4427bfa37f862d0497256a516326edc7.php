<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:67:"E:\CdRoom\generate\public/../application/fish\view\build\index.html";i:1610353418;s:72:"E:\CdRoom\generate\public/../application/fish\view\Public\Baseindex.html";i:1609729343;}*/ ?>
...
<!--        <th>分类</th>-->
    ...
    <tr>
        ...
        <td><?php echo $row['unit_name']; ?>元/㎡</td>
        <td><?php echo $row['total_name']; ?>万</td>
        <td><?php echo $row['l_name']; ?></td>
        <td><?php echo $row['z_name']; ?></td>
<!--        <td><?php echo $row['s_name']; ?></td>-->
        <td><?php echo $row['area']; ?>㎡</td>
        <td>
            <?php if(is_array($row['logos']) || $row['logos'] instanceof \think\Collection || $row['logos'] instanceof \think\Paginator): $i = 0; $__LIST__ = $row['logos'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$logo): $mod = ($i % 2 );++$i;?>
            <img style="width: 60px;height: 40px;" src="<?php echo $logo; ?>" alt="">
            <?php endforeach; endif; else: echo "" ;endif; ?>
        </td>
        <td><img style="width: 100px;height: 80px;" src="<?php echo $row['build_logo']; ?>" alt=""></td>
        <td><?php echo $row['create_time']; ?></td>
        <td><a title="查看" href="<?php echo url('detail',array('id'=>$row['id'])); ?>" class="ml-5" style="text-decoration:none">查看详情</a>
        </td>
        <td class="td-manage">
            <a title="编辑" href="<?php echo url('save',array('id'=>$row['id'])); ?>" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>
            <a title="删除" href="javascript:;" onclick="obj_del(this,<?php echo $row['id']; ?>)" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a>
        </td>
    </tr>
    </tbody>
    <?php endforeach; endif; else: echo "" ;endif; ?>
