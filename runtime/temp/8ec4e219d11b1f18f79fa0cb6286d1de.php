<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:66:"E:\CdRoom\generate\public/../application/fish\view\city\index.html";i:1609729419;s:72:"E:\CdRoom\generate\public/../application/fish\view\Public\Baseindex.html";i:1609729343;}*/ ?>
...
<table class="table table-border table-bordered table-hover table-bg table-sort">
    ...
    <tr>
        ...
        <td class="td-manage">
            <?php if($row['state'] == 1): ?>
            <a style="text-decoration:none" onClick="admin_stop(this,<?php echo $row['id']; ?>)" href="javascript:;" title="停用"><i class="Hui-iconfont">&#xe631;</i>
            <?php else: ?>
            <a style="text-decoration:none" onClick="admin_start(this,<?php echo $row['id']; ?>)" href="javascript:;" title="启用"><i class="Hui-iconfont">&#xe615;</i></a>
            <?php endif; ?>
