<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:66:"E:\CdRoom\generate\public/../application/fish\view\role\index.html";i:1600224905;s:72:"E:\CdRoom\generate\public/../application/fish\view\Public\Baseindex.html";i:1609729343;}*/ ?>
...
<table class="table table-border table-bordered table-hover table-bg table-sort">
    ...
    <tr>
        ...
        <td class="td-manage">
            ...
            </a> <a title="删除" href="javascript:;" onclick="obj_del(this,<?php echo $row['id']; ?>)" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a>
        </td>
    </tr>
    </tbody>
