<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:70:"E:\CdRoom\generate\public/../application/fish\view\dongtai\detail.html";i:1610008447;s:72:"E:\CdRoom\generate\public/../application/fish\view\Public\Baseindex.html";i:1609729343;}*/ ?>
...
<table class="table table-border table-bordered table-hover table-bg table-sort">
    ...
    <tr>
        ...
        <td><img style="width: 100px;height: 80px;" src="<?php echo $row['logo']; ?>" alt=""></td>
        <td><a title="查看" href="<?php echo url('textarea',array('id'=>$row['id'])); ?>" class="ml-5" style="text-decoration:none">查看</a></td>
