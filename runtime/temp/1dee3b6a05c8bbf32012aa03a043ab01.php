<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:79:"E:\CdRoom\generate\public/../application/fish\view\question_feedback\index.html";i:1609404676;s:72:"E:\CdRoom\generate\public/../application/fish\view\Public\Baseindex.html";i:1609729343;}*/ ?>
...
<!--            <a title="编辑" href="<?php echo url('save',array('id'=>$row['id'])); ?>" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i>-->
            </a> <a title="删除" href="javascript:;" onclick="obj_del(this,<?php echo $row['id']; ?>)" class="ml-5"
