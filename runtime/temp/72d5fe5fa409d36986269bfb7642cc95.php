<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:70:"E:\CdRoom\generate\public/../application/fish\view\comment\detail.html";i:1610351525;}*/ ?>
...
<table class="table table-border table-bordered table-hover table-bg table-sort">
    ...
    <tr>
        ...
        <td>
            <a title="查看" href="<?php echo url('Reply/index',array('id'=>$row['id'])); ?>" class="ml-5" style="text-decoration:none">查看回复内容</a>
        </td>
        <td class="td-manage">
