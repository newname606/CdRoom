<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:72:"E:\CdRoom\generate\public/../application/fish\view\house_type\index.html";i:1609731617;s:72:"E:\CdRoom\generate\public/../application/fish\view\Public\Baseindex.html";i:1609729343;}*/ ?>
...
<table class="table table-border table-bordered table-hover table-bg table-sort">
    ...
    <tr>
        ...
        <td class="td-manage">
            <a title="查看" href="<?php echo url('detail',array('id'=>$row['id'])); ?>" class="ml-5" style="text-decoration:none">查看户型</a>
        </td>
    </tr>
    </tbody>
