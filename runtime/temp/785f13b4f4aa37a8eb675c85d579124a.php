<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:71:"E:\CdRoom\generate\public/../application/fish\view\unit_price\save.html";i:1610351380;s:71:"E:\CdRoom\generate\public/../application/fish\view\Public\Basesave.html";i:1610347106;}*/ ?>
<!--_meta 作为公共模版分离出去-->
...
<article class="page-container">
    ...
    <form action="" method="post" class="form form-horizontal" id="form-member-add" enctype="multipart/form-data">
                <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3">楼盘价格</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="<?php echo !empty($row['name'])?$row['name']:''; ?>" name="name">
            </div>
        </div>
